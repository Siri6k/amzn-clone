...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='inventorylog',
            name='po_id',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='po_id_inventory_log', to='OrderServices.purchaseorder'),
        ),
        migrations.AddField(
            model_name='inventorylog',
            name='so_id',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='so_id_inventory_log', to='OrderServices.salesorder'),
        ),
        migrations.AddField(
