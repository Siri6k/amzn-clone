...
class Warehouse(models.Model):
    ...
    domain_user_id = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="domain_user_id_warhouse",
    )
    added_by_user_id = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="added_by_user_id_warhouse",
    )
...
class RackAndShelvesAndFloor(models.Model):
    ...
    warehouse_id = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="warehouse_id_rack_shelf_floor",
    )
    ...
    domain_user_id = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="domain_user_id_rack_shelf_floor",
    )
    added_by_user_id = models.ForeignKey(
        Users,
        on_delete=models.CASCADE,
...
class Inventory(models.Model):
    ...
    purchase_order_id = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="purchase_order_id_inventory",
    )
    purchase_order_item_id = models.ForeignKey(
        PurchaseOrderItems,
        on_delete=models.CASCADE,
        blank=True,
        null=True,
        related_name="purchase_order_item_id_inventory",
    )
    purchase_order_item_inwarded_item_id = models.ForeignKey(
        PurchaseOrderItemInwardedLog,
        on_delete=models.CASCADE,
        blank=True,
        null=True,
        related_name="purchase_order_item_inwarded_item_id_inventory",
    )
    product_id = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="product_id_inventory",
    )
    warehouse_id = models.ForeignKey(
        Warehouse,
        on_delete=models.CASCADE,
        blank=True,
        null=True,
        related_name="warehouse_id_inventory",
    )
    rack_shelf_floor_id = models.ForeignKey(
        RackAndShelvesAndFloor,
        on_delete=models.CASCADE,
        blank=True,
        null=True,
        related_name="rack_shelf_floor_id_inventory",
    )
    ...
    inward_type = models.CharField(
        ...
        choices=[
            ...
            ("WARHOUSE TRANSFER", "WARHOUSE TRANSFER"),
        ],
        default="PURCHASE",
    )
    additional_details = models.JSONField()
